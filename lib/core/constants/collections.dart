...
abstract final class Collections {
  ...
  /// Same pattern as [studentDedupe]: created in the same transaction as the
  /// user, so two Supervisors onboarding the same teacher at once produce one
  /// account and one named rejection.
